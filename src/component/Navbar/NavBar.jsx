            ...
            <nav className={styles.nav}>
                ...
                <div className={styles.right}>
                    <ul className={styles.navList}>
                        ...
                        {isLogin
                            ?<><NavLink to="/orders" className={styles.navItem}>
                        ...
                        {/* Icon and Link for Auth - on click redirect to Sign page*/}
                            <NavLink to="" className={styles.navItem}>
                                ...
                                src={!isLogin?"https://cdn-icons-png.flaticon.com/128/25/25245.png":"https://cdn-icons-png.flaticon.com/128/1828/1828479.png"} 
                                alt="sign out icon"/>
